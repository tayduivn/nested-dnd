...
let getMainWebsite = getWebsite('https://www.fantasynamegenerators.com', (html)=>{
	...
	//matches.sort().forEach(url=>{
		promises.push(getWebsite('https://www.fantasynamegenerators.com/irish-names.php',(html)=>{
...
function getWebsite(url, callback){
	return new Promise((resolve)=>{
		https.get('https://www.fantasynamegenerators.com', 
			function(res) {
