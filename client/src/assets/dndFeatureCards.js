module.exports=
{
	...
	"Augury": {
		...
		"shortDesc": "Cast gem-inlaid sticks, roll dragon bones, or lay out ornate cards to receive an omen"
	},
	"Barkskin": {
	...
	"Detect Evil and Good": {
		"shortDesc": "Locate any aberration, celestial, elemental, fey, fiend, undead, or consecrated/desecrated objects"
	},
	"Detect Magic": {
	...
	"Druidcraft": {
		...
		"shortDesc": "Whisper to the spirits of nature and craft a natural or sensory effect"
	},
	"Enhance Ability": {
		"description": [
	...
	"Find Familiar": {
		...
		"shortDesc": "bat, cat, crab, frog (toad), hawk, lizard, octopus, owl, poisonous snake, fish (quipper), rat, raven, sea horse, spider, or weasel"
	},
	"Find Traps": {
	...
	"Hunter's Mark": {
		"shortDesc": "Mark a creature and add 1d6 damage when you hit it with a weapon"
	},
	"Jump": {
		"shortDesc": "Triple a creature's jump distance for 1 minute"
	},
	"Lesser Restoration": {
		"shortDesc": "Cure a disease or a blinded, deafened, paralyzed, or poisoned condition"
	},
	"Light": {
	...
	"Misty Step": {
		"shortDesc": "Briefly surrounded by silvery mist, you teleport a short distance"
	},
	"Pass without Trace": {
	...
	"Unseen Servant": {
		...
		"shortDesc": "An invisible, mindless, shapeless force that performs simple tasks at your command"
	},
	"Witch Bolt": {
		"cast_time": "1 action",
		"components": {
