		...
		<div className="container-fluid">
			<ul className="nav nav-tabs" role="tablist">
				<li className="nav-item">
					<a className="nav-link active" id="charsheets-tab" 
						href="#charsheets" data-toggle="tab" aria-controls="charsheets" aria-selected="true" role="tab">
						Print Sheet
					</a>
				</li>
				<li className="nav-item">
					<a className="nav-link" id="cards-tab" 
						href="#cards" data-toggle="tab" aria-controls="cards" aria-selected="false" role="tab">
						Print Cards
					</a>
				</li>
				<li className="nav-item">
					<a className="nav-link" id="edit-tab" 
						href="#edit" data-toggle="tab" aria-controls="edit" aria-selected="false" role="tab">
						Edit
					</a>
				</li>
			</ul>
			<div className="tab-content pt-0">
				<div className="tab-pane fade show active" id="charsheets" role="tabpanel" aria-labelledby="charsheets-tab">
