...
var char = {
	...
	classes: [
		{
			knownSpells: {
				notes: {},
				spells: ["Alarm", "Detect Magic", "Hunter's Mark"]
			},
			label: "Ranger",
			level: 3,
			name: "Ranger (Revised)",
	...
	equipment: {
		...
		containers: [
			{
				content: ["A troll's necklace worn as a belt"]
			},
			{
				content: [
		...
		items: ["shortsword", "longbow", "potion of healing"],
	...
	proficiencies: {
		...
		skills: {
			list: ["Investigation", "Stealth", "Insight"],
			notes: []
		},
		tools: {
			list: [""],
...
var char2 = {
	...
	background: {
		...
		startingCoin: "59g 7s",
		personality:
			"If someone is in trouble, I'm always ready to lend help. I have a strong sense of fair play and always try to find the most equitable solution to arguments",
		ideal: "People deserve to be treated with dignity and respect",
		bond:
			"My sister is the most important person to me and I will do anything to protect her. I am loyal to the people of my village.",
		flaw:
		...
		containers: [
			{
				...
				notes: ["Dungeoneer's", "Folk Hero"]
			},
			{
				name: "Component Pouch",
				content: ["a pouch of fine sand", "a bit of fleece"]
			}
		],
		items: ["light crossbow", "dagger"]
	},
	body: {
		age: 30,
		height: "5'5\"",
