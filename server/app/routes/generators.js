		...
		(req, res, next) => {
			...
			getById(req.params.id)
				.then(async generator => {
					...
					// get builtpack
					var builtpack = await BuiltPack.findOrBuild(
						generator.pack.toString()
					);
